  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center bg-white dark:bg-gray-800 p-4 rounded-lg border border-border shadow-sm">
        <div>
          <h1 className="text-2xl font-semibold text-gray-900 dark:text-white">Reports Hub</h1>
          <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">Generate reports.</p>
        </div>
