    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center bg-white dark:bg-gray-800 p-4 rounded-lg border border-border shadow-sm">
        <div>
          ...
          <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">Manage your profile.</p>
        </div>
        <Link href="/profile/new" className="text-sm font-medium text-white bg-primary px-4 py-2 rounded">
          Add New
        </Link>
      </div>
